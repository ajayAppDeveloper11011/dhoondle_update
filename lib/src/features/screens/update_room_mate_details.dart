...
class UpDateRoommatesDetails extends StatefulWidget {
  const UpDateRoommatesDetails({super.key});

  @override
  State<UpDateRoommatesDetails> createState() => _UpDateRoommatesDetailsState();
}

class _UpDateRoommatesDetailsState extends State<UpDateRoommatesDetails> {
  var city = [
    "Indore",
    "Bhopal",
    "Ujjain",
                        ...
                        children: [
                          ...
                          Center(
                            child: MaterialButton(
                              onPressed: () {
                                Helper.checkInternet(addPropertyApiNow());
                                // Get.to(OtpScreen());
  ...
  Future<void> addPropertyApiNow() async {
    ...
    var request = http.MultipartRequest(
        'POST', Uri.parse('https://dhoondle.com/Dhoondle/api/roommate/update/9'));
