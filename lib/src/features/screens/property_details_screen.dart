...
class PropertyDetailsScreen extends StatefulWidget {
  ...
  PropertyDetailsScreen({required this.property_id, this.getPropertyData});
...
class _PropertyDetailsScreenState extends State<PropertyDetailsScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      //             height: 20,
      //           ),
      //           getPropertyData?.first.propertyImage.toString() == null?
      //           Container(
      ...
      //                             imageUrl: getPropertyData!.first.image.toString(),
      //                             fit: BoxFit.fill,
      //                             height: size.height * 0.25,
      ...
      //                                   )
      //                               ),
      //                               child: Text("Rent:${getPropertyData?.first.price.toString()}"))),
      //                     ],
      //                   ));
      //             },
      ...
      //             height: 20,
      //           ),
      //           getPropertyData == null? Container():
      //           AnimatedSmoothIndicator(
      //             activeIndex: currentIndex,
      //             count: getPropertyData!.first.propertyImage!.length,
      //             effect: SlideEffect(
      //                 dotWidth: 12,
      //                 dotHeight: 12,
      ...
      //                 child: Text(
      //                   "${getPropertyData?.first.propertyType} available for rent",
      //                   style: GoogleFonts.roboto(
      ...
      //                     InkWell(
      //                       onTap: ()  {
      //                         _launchPhoneCall(getPropertyData!.first.mobile.toString());
      //                       },
      //                       child: Image.asset(
      //                         Images.Telephone,
      ...
      //                     InkWell(
      //                       onTap: ()  {
      //                         launchWhatsApp(getPropertyData!.first.mobile.toString());
      //                       },
      //                       child: Image.asset(
      //                         Images.Whatsapp,
      //                         height: size.height * 0.03,
              ...
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    ...
                    widget.getPropertyData?.propertyImage==null?  Container(
                      height: size.height*0.25,
                      width: size.width,
                      // padding: EdgeInsets.symmetric(horizontal: 20),
                      // margin: EdgeInsets.symmetric(horizontal: 20),
                              ...
                              children: [
                                Container(
                                  ...
                                  child: ClipRRect(
                                    borderRadius: BorderRadius.circular(20),
                                    child: CachedNetworkImage(
                                      imageUrl:widget.getPropertyData!.propertyImage==null?getPropertyDetailModel?.propertyDetails?.image??'': 'https://dhoondle.com/Dhoondle/${widget.getPropertyData!.propertyImage.toString()}',
                                      fit: BoxFit.fill,
                                      height: size.height * 0.25,
                                      placeholder: (context, url) =>
                                          LinearProgressIndicator(
                                ...
                                Positioned(
                                    ...
                                    child: Container(
                                        ...
                                        child: Text("${widget.getPropertyData?.price==null?getPropertyDetailModel?.propertyDetails?.price:widget.getPropertyData?.price}"))),
                              ],
                            ));
                      },
                      options: CarouselOptions(
                    ...
                    Row(
                      ...
                      children: [
                        Padding(
                          padding: const EdgeInsets.symmetric(horizontal: 20.0),
                          child: Text(
                            "${widget.getPropertyData?.furnished??""} available for rent",
                            style: GoogleFonts.roboto(
                                color: AppColors.textcolor,
                                fontWeight: FontWeight.w500,
                                fontSize: 16),
                        ...
                        Padding(
                          ...
                          child: Row(
                            children: [
                              InkWell(
                                onTap: ()  {
                                  _launchPhoneCall("${widget.getPropertyData?.mobile}");
                                },
                                child: Image.asset(
                                  Images.Telephone,
                                  height: size.height * 0.03,
                              ...
                              InkWell(
                                onTap: ()  {
                                  launchWhatsApp("${widget.getPropertyData?.mobile}");
                                },
                                child: Image.asset(
                                  Images.Whatsapp,
                                  height: size.height * 0.03,
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        Padding(
                          padding: const EdgeInsets.symmetric(horizontal: 20.0),
                          child: Text(
                            widget.getPropertyData?.description==null?getPropertyDetailModel?.propertyDetails?.description??'':widget.getPropertyData!.description.toString(),
                            style: GoogleFonts.roboto(
                                color: AppColors.greycolor,
                                fontWeight: FontWeight.w400,
                                fontSize: 14),
                        ...
                        Padding(
                          padding: const EdgeInsets.symmetric(horizontal: 20.0),
                          child: Text(
                            "${widget.getPropertyData?.price==null?getPropertyDetailModel?.propertyDetails?.price:widget.getPropertyData?.price.toString()} Rs/Month",
                            style: GoogleFonts.roboto(
                                color: AppColors.greycolor,
                                fontWeight: FontWeight.w400,
                                fontSize: 14),
                        ...
                        Padding(
                          padding: const EdgeInsets.symmetric(horizontal: 20.0),
                          child: Text(
                            widget.getPropertyData?.address==null?getPropertyDetailModel?.propertyDetails?.address??'': widget.getPropertyData?.address??"",
                            style: GoogleFonts.roboto(
                                color: AppColors.greycolor,
                                fontWeight: FontWeight.w400,
                                fontSize: 14),
                        ...
                        Padding(
                          padding: const EdgeInsets.symmetric(horizontal: 20.0),
                          child: Text(
                            widget.getPropertyData?.city==null?getPropertyDetailModel?.propertyDetails?.city??'': widget.getPropertyData?.city??"",
                            style: GoogleFonts.roboto(
                                color: AppColors.greycolor,
                                fontWeight: FontWeight.w400,
                                fontSize: 14),
                        ...
                        Padding(
                          padding: const EdgeInsets.symmetric(horizontal: 20.0),
                          child: Text(
                            widget.getPropertyData?.furnished==null?getPropertyDetailModel?.propertyDetails?.city??'':widget.getPropertyData?.furnished??"",
                            style: GoogleFonts.roboto(
                                color: AppColors.greycolor,
                                fontWeight: FontWeight.w400,
                                fontSize: 14),
                        ...
                        Padding(
                          padding: const EdgeInsets.symmetric(horizontal: 20.0),
                          child: Text(
                            widget.getPropertyData?.name==null?getPropertyDetailModel?.propertyDetails?.name??'': widget.getPropertyData?.name??"",
                            style: GoogleFonts.roboto(
                                color: AppColors.greycolor,
                                fontWeight: FontWeight.w400,
                                fontSize: 14),
...
//                                         ),
//                                         child:  Center(
//                                           child: Text( widget.getPropertyData?.propertyType??"",
//                                               style: GoogleFonts.poppins(
//                                                 textStyle: TextStyle(
//                                                   color: Colors.white,
//                                                   fontSize: 15,
