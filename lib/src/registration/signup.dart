...
class _SignupState extends State<Signup> {
                  ...
                  child: Form(
                    ...
                    child: Column(
                      ...
                      children: [
                        //header part
                        SignupHeader(
                          header: getTranslated(context, 'Sign Up'),
                          description: getTranslated(context, 'Please enter details to Sign Up'),
                        ),
                          ...
                          child: TextFormField(
                            ...
                            validator: (name) {
                              if (name!.isEmpty || name.length < 3) {
                                // nameValue.value = 1;
                                ToastMessage.msg(getTranslated(context, "Please enter valid name"));
                                return null;
                              } else {
                                // nameValue.value = 0;
                              }
                          ...
                          child: TextFormField(
                            ...
                            validator: (address) {
                              if (address!.isEmpty || address.length < 8) {
                                ...
                                ToastMessage.msg(getTranslated(context, "Please enter valid address"));
                                return null;
                              } else {
                        ...
                        Container(
                          ...
                          child: TextFormField(
                            ...
                            textInputAction: TextInputAction.next,
                            decoration: InputDecoration(
                              hintText: getTranslated(context, 'Email  (Optional)'),
                              border: InputBorder.none,
                              fillColor: AppColors.FillColor,
                              filled: true,
                              hintStyle: GoogleFonts.lato(
                            ...
                            validator: (email) {
                              ...
                              if (email!.isEmpty ||
                                ...
                                ToastMessage.msg(getTranslated(context, "Please enter valid email"));
                                // emailValue.value = 1;
                                return null;
                              }
                            },
                          ...
                          child: TextFormField(
                              ...
                              validator: (value) {
                                if (value!.isEmpty || value.length != 10) {
                                  // mobileValue.value = 1;
                                  ToastMessage.msg(
                                      getTranslated(context, "Please enter valid mobile number"));
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              InkWell(
                                ...
                                child: Text(getTranslated(context, "Log In"),
                                    style: GoogleFonts.lato(
                                        fontSize: 14,
                                        color: AppColors.GreenTextColor,
                                        fontWeight: FontWeight.w500)),
  ...
  Future<void> phoneCheckWithFirebase() async {
    ...
    if (allData.length == 0) {
      ...
      ToastMessage.msg(getTranslated(context, "Phone number already registered, Please sign in"));
